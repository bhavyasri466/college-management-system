...
// Insert leave application (POST method)
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO leaves (employee_id, leave_from, leave_to, reason) 
            VALUES (:employee_id, :leave_from, :leave_to, :reason)";
    $stmt = $pdo->prepare($sql);
    $stmt->execute(['employee_id' => $emp_id, 'leave_from' => $leave_from, 'leave_to' => $leave_to, 'reason' => $reason]);
...
<body>
    <div class="container">
        ...
        <div class="navbar">
            ...
            <a href="leaves.php" class="active"><i class="fas fa-calendar-minus"></i> Leaves</a>
            <a href="logout.php" class="logout"><i class="fas fa-sign-out-alt"></i> Logout</a>
        </div>

        <h1><i class="fas fa-calendar-minus"></i> Leave Applications</h1>
        ...
        <form method="POST" action="leaves.php">
            ...
            <button type="submit"><i class="fas fa-plus-circle"></i> Apply Leave</button>
        </form>

        <!-- Display Leave Applications -->
        <h2><i class="fas fa-list"></i> Leave Applications</h2>
        <table>
            <thead>
                <tr>
                    <th>Employee ID</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo htmlspecialchars($leave['leave_from']); ?></td>
                    <td><?php echo htmlspecialchars($leave['leave_to']); ?></td>
                    ...
                    <td>
                        <a href="edit_leave.php?id=<?php echo $leave['leave_id']; ?>" class="action-link">
