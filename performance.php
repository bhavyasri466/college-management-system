...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO performance (employee_id, review, rating, review_date) 
            VALUES (:employee_id, :review, :rating, :review_date)";
    $stmt = $pdo->prepare($sql);
    $stmt->execute(['employee_id' => $emp_id, 'review' => $review, 'rating' => $rating, 'review_date' => $review_date]);
    ...
    <div class="container">
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td><?php echo htmlspecialchars($review['employee_id']); ?></td>
