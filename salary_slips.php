...
$sql = "SELECT s.slip_id, s.employee_id, s.month, s.year, s.basic_salary, 
...
$sql = "SELECT employee_id, name as employee_name FROM employee";
$stmt = $pdo->prepare($sql);
$stmt->execute();
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO salary_slip (employee_id, month, year, basic_salary, allowances, deductions, net_salary) 
            VALUES (:employee_id, :month, :year, :basic_salary, :allowances, :deductions, :net_salary)";
    $stmt = $pdo->prepare($sql);
    $stmt->execute([
        'employee_id' => $emp_id,
